    ...
    <?php while ($row = $stmt->fetch(PDO::FETCH_ASSOC)): ?>
        <div class="product-card">
            ...
            <?php if (!empty($row['image_path'])): ?>
                ...
                <?php else: ?>
                    <img src="choco latte.jpg" alt="choco latte Image">
                    <img src="ultra burger.jpg" alt="ultra burger Image">  
                    <img src="Bilao.jpg" alt="Bilao Image">
                    <img src="cheese burger.jpg" alt="cheese burger Image"> 
                    <img src="spicy chicken burger.jpg" alt="spicy chicken burger Image"> 
                    <img src="Iced tea.jpg" alt="Iced tea Image"> 
                    <img src="Nachos(1).jpg" alt="Nachos(1) Image">  
